...
-(void)viewDidLoad {
    ...
    if (!initialized && location == 0) {
        ...
        NSMutableArray *constraints = [@[[self.axnView.centerXAnchor constraintEqualToAnchor:stackView.centerXAnchor],
...
-(void)viewDidLoad{
    ...
    if (!initialized && location == 1) {
        ...
        NSMutableArray *constraints = [@[[axnView.centerXAnchor constraintEqualToAnchor:self.view.centerXAnchor],
