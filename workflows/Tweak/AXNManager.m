...
#ifdef THEOS_PACKAGE_SCHEME_ROOTHIDE
    return jbroot(@"/var/mobile/Documents/AxonDebug.txt");
#else
    return @"/var/mobile/Documents/AxonDebug.txt";
#endif
}
...
-(void)saveNotificationForDebug {
    ...
    [[array description] writeToFile:getDebugFilePath() atomically:false encoding:NSUTF8StringEncoding error:nil];
}
